...
function WatchHistory() {
  ...
  return (
    ...
    <div className='container mt-5 mb-5 mb-3 d-flex justify-content-between'>


      <h2>WatchHistory</h2>
      <Link style={{textDecoration:"none",color:"blueviolet",fontSize:"30px"}} to={"/home"}>Back to Home
      <i class="fa-solid fa-backward fa-beat"></i></Link>
      </div>
      ...
      <div className='container mt-5 mb-3 w-100'>
        <table className='table shadow w-100 p-3 m-2'>
         ...
         history?.length>0?history.map((video,index)=>(
          ...
          <td><button className='text-danger btn' onClick={()=>removeVideoHistory(video?.id)}><i class="fa-solid fa-trash"></i></button>
          </td>
          </tr>
